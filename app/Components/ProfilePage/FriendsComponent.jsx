...
function FriendSuggestion({ myButton, header}) {
  ...
  const renderButton = () => {
    if (myButton === "addDelete") {
      ...
      return (
        <button className="w-full text-start text-sky-500 max-[399px]:text-center max-[399px]:bg-blue-400 max-[399px]:text-white max-[399px]:py-2 rounded-lg">{t("PROFILE")}</button>
      );
    }
  };
  ...
  return (
    <div className="font-medium mb-4">
      <h1 className="text-lg md:text-xl lg:text-2xl font-semibold mb-2">{header}</h1>
